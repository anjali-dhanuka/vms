...
class Report(LiveServerTestCase):
    ...
    def test_reject_report(self):
        ...
        report_page = self.report_page
        report_page.get_page(self.live_server_url, PageUrls.administrator_report_page)
        self.assertEqual(report_page.element_by_xpath(self.elements.REJECT_REPORT).text, 'Reject')

        report_page.element_by_xpath(self.elements.REJECT_REPORT + '//a').click()
        with self.assertRaises(NoSuchElementException):
            report_page.element_by_xpath('//table//tbody//tr[1]')
    ...
    def test_approve_report(self):
        ...
        report_page.get_page(self.live_server_url, PageUrls.administrator_report_page)
        report_page.go_to_view_report_page()
        self.assertEqual(report_page.element_by_xpath(self.elements.APPROVE_REPORT).text, 'Approve Report')
        report_page.element_by_xpath(self.elements.APPROVE_REPORT + '//a').click()
